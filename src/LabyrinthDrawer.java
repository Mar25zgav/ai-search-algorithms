...
public class LabyrinthDrawer {
    ...
    public void AStar() {
        AStar.search(convertToGraph(labyrinth), startNode, endNodes, getCosts(labyrinth), finalNode);
    ...
    public void IDAStar() {
        ...
        idas.drawPath(convertToGraph(labyrinth).length);
